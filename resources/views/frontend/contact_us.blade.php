...
@section('contact-us-body')
    ...
    <main class="">
                ...
                <div class="row">
                    <div
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="text-light mb-0">Contact Us</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- contact us hero end -->
        <!-- Don't hesitate start -->
        <section class="donot-hesitate">
            <div class="container">
                <div class="row">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 donot-hesitate-cards">
                    <div class="col">
                        <div class="card h-100 rounded-0">
                            <div class="row contact-us-single-card-content">
                                <div class="col-2 contact-us-single-card-content-left">
                                    <div class="contact-us-single-card-content-left-icon">
                                        <i class="fa fa-map-marker"></i>
                                    </div>
                                </div>
                                <div class="col-10 contact-us-single-card-content-right">
                                    <div class="card-body">
                                        <h5 class="card-title">Address</h5>
                                        <p class="card-text small">GymVast, 18 East 50th Street, 4th Floor, New York, NY
                                            22
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="row contact-us-single-card-content">
                                ...
                                <div class="col-10 contact-us-single-card-content-right">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text small">+0123(456)77899 <br>1234567899
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="contact-us-map">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3979.7786647578782!2d39.66841747377167!3d-4.065477744977225!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x184013daee3082b3%3A0x73d7705f0421182e!2sFREEMASON%20HALL%20MOMBASA!5e0!3m2!1sen!2sbd!4v1678771967317!5m2!1sen!2sbd"
                width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                referrerpolicy="no-referrer-when-downgrade"></iframe>
        </section>
        <!-- contact us map end -->
        <!-- home book now form start -->
        <section class="home-book-now-form mb-5 pb-5">
            <div class="container home-book-now-form-container py-4 px-5">
                <div class="py-3 px-4 upper-before-after">
                    <div class="py-3 px-3 lower-before-after">
                        <h2 class="text-center fw-bold py-4">Send A Message</h2>
                        <form action="">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-md-4 home-book-now-form-input-with-icon">
                                    <input type="email" class="form-control rounded-1 py-3 px-4 fw-semibold"
                                ...
                                <div class="form-floating home-book-now-form-input-with-icon">
                                    <textarea class="form-control rounded-1 py-3 px-4 fw-semibold "
                                              placeholder="Leave a comment here" id="floatingTextarea2"
                                              style="height: 100px"></textarea>
                                    <label for="floatingTextarea2" class="rounded-1 py-3 px-4 fw-semibold">Write
                                        Message</label>
