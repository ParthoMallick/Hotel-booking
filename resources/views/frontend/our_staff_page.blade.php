...
@section('our-staff')
    ...
    <!-- main start -->
    <main class="">
        <!-- our staff hero start -->
        <section class="our-staff-hero py-5">
            <div class="container py-5 our-staff-hero-content">
                <div class="d-flex align-items-center justify-content-center our-staff-hero-content-bg-text">
                    <h2 class="text-light">Staffs</h2>
                </div>
                <div class="row">
                    <div
                        class="d-flex flex-column align-items-center justify-content-center our-staff-hero-content-left">
                        <h3 class="text-light">Our Staffs</h3>
                        <div class="d-flex align-items-center">
                            <h5 class="text-warning mb-0">Home</h5>
                            <i class="fa fa-angle-double-right text-light px-3"></i>
                            <h5 class="text-light mb-0">Staffs</h5>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <!-- our staff hero start end -->

        <!-- our staff card start -->
        <section class="our-staff-card my-5">
            <div class="container our-staff-card-container py-5">
                    ...
                    @foreach($ourStaffs as $staff)
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <img src="{{asset('storage/staff-images/'.$staff->image)}}" class="card-img-top" alt="...">
                                <div class="card-body mx-auto">
                                    <h5 class="card-title text-center fw-bold">{{$staff->name}}</h5>
                                    <p class="card-text text-center text-warning">{{$staff->designation}}</p>
                                </div>
                            </div>
                        </div>
                ...
                <nav class="custome-pagination" aria-label="Page navigation example">
                    <ul class="pagination justify-content-center pt-5 custome-pagination-list">
                        ...
                        <li class="page-item mx-3"><a class="page-link pagination-item rounded-pill" href="#">2</a></li>
